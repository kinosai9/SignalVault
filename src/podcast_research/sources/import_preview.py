...
from podcast_research.adapters.allin_zh_notes import SITE_BASE
...
def build_import_preview(url: str, vault_path: Path) -> ImportPreview:
    ...
    if is_allin:
        ...
        from podcast_research.adapters.generic_web_page import (
...
def _execute_deep_notes_import(
    ...
    from podcast_research.adapters.allin_zh_notes import AllInZHNotesAdapter
    from podcast_research.exporters.deep_notes import export_deep_note
...
def _build_source_archive_body(
    ...
    sections.extend([
        "---",
        "",
        f"*此归档由 podcast-research P2-S.3.1 自动生成，"
...
def _infer_allin_quality(doc) -> str:
    ...
    from podcast_research.exporters.deep_notes import check_document_health
