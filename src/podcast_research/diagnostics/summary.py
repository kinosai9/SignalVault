...
RECOVERY_ACTIONS: list[RecoveryAction] = [
    ...
    RecoveryAction(
        ...
        command="podcast-research zsxq groups --refresh",
        severity="info",
        category="zsxq",
    ),
    RecoveryAction(
        ...
        command="podcast-research ingest retry <job_id>",
        severity="warning",
        category="ingest",
    ),
    RecoveryAction(
        ...
        command="podcast-research review list",
        severity="warning",
        category="review",
    ),
    RecoveryAction(
        ...
        command="podcast-research vault-lint --vault <path>",
        severity="info",
        category="vault",
    ),
    RecoveryAction(
        ...
        command="podcast-research graph rebuild",
        severity="warning",
        category="graph",
    ),
    RecoveryAction(
    ...
    RecoveryAction(
        ...
        command="podcast-research diagnostics bundle --output ./diagnostics",
        severity="info",
        category="config",
...
class DiagnosticsCenter:
    ...
    def _check_search(session=None) -> SubsystemStatus:
        ...
        try:
            ...
            results = unified_search(session or __import__("podcast_research.db.session", fromlist=["get_session"]).get_session(),
                                     keyword="测试", limit=1)
    ...
    def _check_graph(session=None) -> SubsystemStatus:
        try:
            ...
            from podcast_research.db.models import KnowledgeEdge, KnowledgeNode
    ...
    def _check_config() -> SubsystemStatus:
        ...
        from podcast_research.config import (
            DATA_DIR,
            DB_PATH,
            LLM_API_KEY,
            LLM_MODEL,
