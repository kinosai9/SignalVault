...
def _register_builtin_codes() -> None:
    ...
    ErrorCodeRegistry.register(ErrorRecord(
        ...
        related_command="podcast-research doctor",
    ))
    ErrorCodeRegistry.register(ErrorRecord(
    ...
    ErrorCodeRegistry.register(ErrorRecord(
        ...
        suggested_actions=["运行 zsxq-cli auth login", "运行 podcast-research zsxq doctor 检查状态"],
        related_command="podcast-research zsxq doctor",
    ...
    ErrorCodeRegistry.register(ErrorRecord(
        ...
        suggested_actions=["在知识星球 App 中确认订阅状态",
                           "运行 podcast-research zsxq groups --refresh 刷新授权"],
        related_command="podcast-research zsxq groups --refresh",
    ...
    ErrorCodeRegistry.register(ErrorRecord(
        ...
        related_command="podcast-research pdf preview <file>",
    ...
    ErrorCodeRegistry.register(ErrorRecord(
        ...
        suggested_actions=["稍后重试分析", "如果持续失败，运行 podcast-research doctor 检查系统状态",
                           "缩短分析内容或更换信息源"],
        related_command="podcast-research doctor",
    ))
    ErrorCodeRegistry.register(ErrorRecord(
    ...
    ErrorCodeRegistry.register(ErrorRecord(
        ...
        suggested_actions=["确认 data/ 目录存在", "检查磁盘空间", "如果数据库损坏，可删除 data/podcast_analyst.db 重新初始化"],
        related_command="podcast-research doctor",
    ))
    ErrorCodeRegistry.register(ErrorRecord(
    ...
    ErrorCodeRegistry.register(ErrorRecord(
        ...
        related_command="podcast-research vault-lint --vault <path>",
    ))
    ErrorCodeRegistry.register(ErrorRecord(
    ...
    ErrorCodeRegistry.register(ErrorRecord(
        ...
        suggested_actions=["运行 podcast-research graph rebuild 重新构建"],
        related_command="podcast-research graph rebuild",
    ))
    ...
    ErrorCodeRegistry.register(ErrorRecord(
        ...
        suggested_actions=["安装缺失的工具", "运行 podcast-research doctor 检查依赖"],
        related_command="podcast-research doctor",
