...
from signalvault.mcp_server.serializers import (
    serialize_channel,
    serialize_entity,
...
def _query_search_entities(
    ...
    from signalvault.db.repository import list_entities
...
def _query_get_entity_profile(entity_name: str) -> dict | None:
    ...
    from signalvault.db.models import EntityRecord, InvestmentViewRecord
...
async def handle_call_tool(name: str, arguments: dict) -> list[TextContent]:
    ...
    try:
        if name == "search_reports":
            ...
            from signalvault.db.knowledge_graph import list_graph_edges
            session = get_session()
            try:
