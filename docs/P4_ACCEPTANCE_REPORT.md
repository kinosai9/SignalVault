...
把 PDF 材料接入 podcast_research 的知识库后端。
...
python -m podcast_research pdf preview <file.pdf> --write-review

# PDF 文本提取
python -m podcast_research pdf extract <file.pdf>
python -m podcast_research pdf extract <file.pdf> --json
python -m podcast_research pdf extract <file.pdf> -o output.txt

# PDF 分析（生成投资研究报告）
python -m podcast_research pdf analyze <file.pdf>                     # mock 分析
python -m podcast_research pdf analyze <file.pdf> --no-mock           # 真实 LLM
python -m podcast_research pdf analyze <file.pdf> --focus "AI投资"
python -m podcast_research pdf analyze <file.pdf> --write-review
```
