...
**P7 后端/CLI 能力已基本完成，前端体验已实现四条主用户动线。** P0–P7 已交付到多源摄入、PDF 分析、ZSXQ 只读导入、统一搜索、轻量图谱、SourceDocument/SourceSegment 原文层、诊断中心与诊断包导出。当前 `python -m pytest --collect-only -q` 可收集 1993 tests。
